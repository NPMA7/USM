...
export default function Navbar() {
  ...
  useEffect(() => {
    ...
    const checkLoginStatus = () => {
      ...
      if (userData && loginTime) {
        ...
        // Jika sudah lebih dari 1 jam sejak login
        if (currentTime - parseInt(loginTime) > oneHour) {
          ...
          // Tampilkan modal jika pengguna masih di halaman
    ...
    // Tambahkan interval untuk memeriksa status login secara berkala
    const loginCheckInterval = setInterval(checkLoginStatus, 60000); // Cek setiap 1 menit
  ...
  const toggleDropdown = () => {
    setIsOpen(!isOpen);
    setIsHamburgerOpen(false); // Tutup hamburger saat dropdown dibuka
  };
                ...
                {isLoggedIn ? (
                  ...
                  <>
                    ...
                    <button 
                      ...
                      className="flex items-center w-full px-4 py-2 text-red-600 hover:bg-gray-200 transition duration-200"
                    >
                      <svg 
                        xmlns="http://www.w3.org/2000/svg" 
                        fill="none" 
